...
?>
	<tr>
		...
		<td><?php if ($cha->icon):?>
			<a href="/ccft/fchallengedetails?id=<?=$e($cha->id)?>"><img src="<?=$e($cha->icon)?>" style="height: 1em" /></a><?php endif; ?> 
			<b><a href="/ccft/fchallengedetails?id=<?=$e($cha->id)?>"><?=$e($cha->name)?></a></b>
		</td>
...
<table class="bordered">
		<tr>
			...
			foreach ($challenges_in_set as $c) {
				...
				echo '<th>' . $e($c->week) . '. ';
				if ($cha->icon) echo '<a href="/ccft/fchallengedetails?id='.$c->id.'"><img src="'.$e($c->icon).'" style="height: 1.5em" /></a>';
				echo "</th>";
			}
			?>
		</tr>
