<?php
	...
	echo     "<li>" . _("During July, the webtiles server <a href='https://cco.crawlcosplay.org' target='_blank'>CCO</a> will be moviving to a European server in order to reduce monthly costs and will also be hosting Dungeon Crawl Chili.") . "</li></ul>";
