<?php
	...
	echo '<h3><a href="https://www.dungeoncrawlcentral.org/" target="_blank">Dungeon Crawl Central</a> ' . _("is the NEW website with many forks to choose from.") . "</h3>";
	echo '<ul><li><a href="https://www.dungeoncrawlcentral.org/online_servers.html" target="_blank">' . _("Play online") . "</a>" . _(" on a Webtiles server.") . "</li>";
