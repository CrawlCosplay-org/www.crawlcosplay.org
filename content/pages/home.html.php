<?php
	...
	echo '<h3><a href="https://www.dungeoncrawlcentral.org/" target="_blank">Dungeon Crawl Central</a> (DC) ' . _("is the website with many Dungeon Crawl forks to choose from.") . "</h3>";
	echo '<ul><li><a href="https://www.dungeoncrawlcentral.org/online_servers" target="_blank">' . _("Play online") . "</a>" . _(" on a Webtiles server.") . "</li>";
	echo     '<li><a href="https://www.dungeoncrawlcentral.org/download_forks" target="_blank">' . _("Download") . "</a>" . _(" an offline version of one of the DC forks.") . "</li>";
