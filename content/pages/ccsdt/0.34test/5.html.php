<title>Week 5 &mdash; TeFE</title>
    ...
    <h2>Week 5 &mdash; TeFE</h2></div><div id="content"><div id="times"><span class="label">Week of 2025-10-03</span></div><div id="combo"><span class="label">Character: </span>Tengu Fire Elementalist</div>
...
<div id="gods"><span class="label">Gods: </span>Jiyva, Vehumet, Makhleb</div><br><pre>LEGEND<br>------<br>Green = Won<br>Red   = Died<br>Grey  = ongoing or did not finish</right></pre><div class="card"><table><tr class="head">
    <th>Player</th>
    <th>Unique Kill</th>
    <th>Branch Enter</th>
    <th>Branch End</th>
